      ...
      <div className="grid grid-cols-2 py-11 px-20 gap-12 mt-14 bg-ruby rounded-3xl z-10 relative">
        ...
        <div id="first-col">
          ...
          <ul className="list-disc pl-6 text-white/[0.6] mt-4 font-medium">
            <li>
              Staking & Yield Farming: Earn passive income by staking in
              liquidity pools while playing games.
            </li>
            <li>
              Profile Exploration: Explore player profiles, activities, and ENS.
            </li>
          </ul>
        </div>
        ...
        <div id="second-col" className="flex flex-col gap-6">
          ...
          <div className="border border-[#E504983D] p-5 flex flex-col gap-3 inner-purple-shadow rounded-xl">
            ...
            <p className="text-white">
              Users can stake Mantle tokens in virtual liquidity pools to earn
              APTC tokens, which are used for betting, gaming, and rewards.
              (Mantle Tokens are equivalent to in-game currency token APTC)
            </p>
            <ul className="list-disc pl-6 text-white mt-2">
              <li>
                Leverages Protocol’s unified liquidity to eliminate slippage and
                ensure efficient gameplay across multiple chains.
                <li>
                  Real-time asset prices for accurate lending calculations.
                </li>
              </li>
            </ul>
          </div>
          ...
          <div className="border border-[#E504983D] p-5 flex flex-col gap-3 inner-purple-shadow rounded-xl">
            <h2 className="text-dark-kiss text-sm font-semibold">
              No Traps, No Restrictions
            </h2>
            <p className="text-white">
              Enjoy flexible withdrawal policies, transparent bonus schemes, and
              full control over your assets through decentralized asset
              management.
            </p>
          </div>
        </div>
